    ...
    <View style={styles.container}>      
      ...
      <View style={styles.conteudo3}>
          ...
          style={styles.inputPicker}>
              ...
              <Picker.Item label='Artes Marciais' value="Ler" />
      ...
      <View style={styles.conteudo4}>
        <Text style={styles.textoResultados}>Nome:</Text>
        <Text style={styles.textoResultados}>Endereço:</Text>
        <Text style={styles.textoResultados}>Telefone:</Text>
        <Text style={styles.textoResultados}>Email:</Text>
        <Text style={styles.textoResultados}>Hobby:</Text>
        <Text style={styles.textoResultados}>Aceito:👎</Text>
      </View>
    </View>
  );
}
